...
namespace EF4TestsWinApp
{
    ...
    /// </summary>
    public partial class EF4TestsEntities6 : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new EF4TestsEntities6 object using the connection string found in the 'EF4TestsEntities6' section of the application configuration file.
        /// </summary>
        public EF4TestsEntities6() : base("name=EF4TestsEntities6", "EF4TestsEntities6")
        {
        ...
        /// <summary>
        /// Initialize a new EF4TestsEntities6 object.
        /// </summary>
        public EF4TestsEntities6(string connectionString) : base(connectionString, "EF4TestsEntities6")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new EF4TestsEntities6 object.
        /// </summary>
        public EF4TestsEntities6(EntityConnection connection) : base(connection, "EF4TestsEntities6")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }

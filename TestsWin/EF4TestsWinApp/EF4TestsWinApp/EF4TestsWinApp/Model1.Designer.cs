...
namespace EF4TestsWinApp
{
    ...
    /// </summary>
    public partial class EF4TestsEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new EF4TestsEntities object using the connection string found in the 'EF4TestsEntities' section of the application configuration file.
        /// </summary>
        public EF4TestsEntities() : base("name=EF4TestsEntities", "EF4TestsEntities")
        {
        ...
        /// <summary>
        /// Initialize a new EF4TestsEntities object.
        /// </summary>
        public EF4TestsEntities(string connectionString) : base(connectionString, "EF4TestsEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new EF4TestsEntities object.
        /// </summary>
        public EF4TestsEntities(EntityConnection connection) : base(connection, "EF4TestsEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }

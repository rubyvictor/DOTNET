...
[assembly: EdmRelationshipAttribute("EF4TestsModel", "CustomerProduct", "Customers", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(EF4TestsWinApp.Customer), "Products", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(EF4TestsWinApp.Product))]
...
namespace EF4TestsWinApp
{
    ...
    /// </summary>
    public partial class EF4TestsEntities4 : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new EF4TestsEntities4 object using the connection string found in the 'EF4TestsEntities4' section of the application configuration file.
        /// </summary>
        public EF4TestsEntities4() : base("name=EF4TestsEntities4", "EF4TestsEntities4")
        {
        ...
        /// <summary>
        /// Initialize a new EF4TestsEntities4 object.
        /// </summary>
        public EF4TestsEntities4(string connectionString) : base(connectionString, "EF4TestsEntities4")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new EF4TestsEntities4 object.
        /// </summary>
        public EF4TestsEntities4(EntityConnection connection) : base(connection, "EF4TestsEntities4")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    public partial class Customer : EntityObject
    {
        ...
        public static Customer CreateCustomer(global::System.String customerID, global::System.String memberCategory)
        {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("EF4TestsModel", "CustomerProduct", "Products")]
        public EntityCollection<Product> Products
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Product>("EF4TestsModel.CustomerProduct", "Products");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Product>("EF4TestsModel.CustomerProduct", "Products", value);
                }
            }
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="EF4TestsModel", Name="Product")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class Product : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("EF4TestsModel", "CustomerProduct", "Customers")]
        public EntityCollection<Customer> Customers
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<Customer>("EF4TestsModel.CustomerProduct", "Customers");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<Customer>("EF4TestsModel.CustomerProduct", "Customers", value);
                }
            }
        }
